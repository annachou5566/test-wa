...
SCOPES = {
    "IBIT": ("2024-01-11", "2026-08-18"), "FBTC": ("2024-01-11", "2026-08-18"),
    "BITB": ("2024-01-11", "2026-08-18"), "ARKB": ("2024-01-11", "2026-08-18"),
    "BTCO": ("2024-01-11", "2026-08-18"), "EZBC": ("2024-01-11", "2026-08-18"),
    "BRRR": ("2024-01-11", "2026-08-18"), "HODL": ("2024-01-11", "2026-08-18"),
    "BTCW": ("2024-01-11", "2026-08-18"), "MSBT": ("2026-04-08", "2026-08-18"),
    "GBTC": ("2024-01-11", "2026-08-18"), "BTC": ("2024-07-31", "2026-08-18"),
    "OBTC": ("2025-12-19", "2026-08-18"), "DEFI": ("2024-03-27", "2026-08-17"),
}
...
def main():
    summary={"scope":"FARSIDE_BTC_HISTORY_COMPLETENESS_EXACT_PUBLIC_TABLE_AUDIT","source_url":URL,"retrieved_at_utc":now_utc(),"transport":"ordinary-python-urllib-direct-http","proxy_used":False,"stealth_used":False,"challenge_bypass_used":False,"secrets_used":False,"http_status":None,"artifact_sha256":None,"response_last_modified":None,"response_date":None,"table_last_date":None,"columns":[],"funds":{},"error":None}
    try:
        req=urllib.request.Request(URL,method="GET")
        with urllib.request.urlopen(req,timeout=30) as resp:
            body=resp.read(MAX_BYTES+1)
            if len(body)>MAX_BYTES: raise RuntimeError("FARSIDE_BODY_TOO_LARGE")
            summary["http_status"]=resp.status; summary["response_last_modified"]=resp.headers.get("Last-Modified"); summary["response_date"]=resp.headers.get("Date")
        summary["artifact_sha256"]=hashlib.sha256(body).hexdigest(); (OUT/"farside-btc-all-data.html").write_bytes(body)
        parser=TableParser(); parser.feed(body.decode("utf-8",errors="replace")); target=None
